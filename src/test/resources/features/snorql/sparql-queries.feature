Feature: Sparql search neXtProt
  ...
  Scenario: Scroll and run query NXQ_00061
    Given I scroll to sparql query "NXQ_00061"
    And I select sparql query "NXQ_00061"
    When I click on button "Go"
    Then the page source should contain texts
      | entry:NX_P00491 |
      | entry:NX_P06493 |
  ...
  Scenario Outline: Check saved queries run and return appropriate result
    ...
    When I click on button "Go"
    Then the sparql results should contain text "<result>"
